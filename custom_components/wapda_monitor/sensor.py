...
async def async_setup_entry(
    ...
    entities: list[SensorEntity] = [
        # --- Load / Feeder sensors ---
        WapdaSensor(coordinator, reference, "feeder_status",
                    category="load",
                    value_fn=lambda d: d.get("current_status")),
        WapdaSensor(coordinator, reference, "feeder_name",
                    category="load",
                    entity_category=EntityCategory.DIAGNOSTIC,
                    value_fn=lambda d: d.get("feeder")),
        WapdaSensor(coordinator, reference, "grid_name",
                    category="load",
                    entity_category=EntityCategory.DIAGNOSTIC,
                    value_fn=lambda d: d.get("grid")),
        WapdaSensor(coordinator, reference, "feeder_voltage",
                    category="load",
                    device_class=SensorDeviceClass.VOLTAGE,
                    unit=UnitOfElectricPotential.KILOVOLT,
                    state_class=SensorStateClass.MEASUREMENT,
                    value_fn=lambda d: _num(d.get("voltage"))),
        WapdaSensor(coordinator, reference, "feeder_current",
                    category="load",
                    device_class=SensorDeviceClass.CURRENT,
                    unit=UnitOfElectricCurrent.AMPERE,
                    state_class=SensorStateClass.MEASUREMENT,
                    value_fn=lambda d: _num(d.get("current"))),
        WapdaSensor(coordinator, reference, "active_power",
                    category="load",
                    device_class=SensorDeviceClass.POWER,
                    unit=UnitOfPower.KILO_WATT,
                    state_class=SensorStateClass.MEASUREMENT,
                    value_fn=lambda d: _num(d.get("active_power_kW"))),
        WapdaSensor(coordinator, reference, "reactive_power",
                    category="load",
                    unit="kVar",
                    state_class=SensorStateClass.MEASUREMENT,
                    disabled_by_default=True,
                    value_fn=lambda d: _num(d.get("reactive_power_kVar"))),
        WapdaSensor(coordinator, reference, "power_factor",
                    category="load",
                    device_class=SensorDeviceClass.POWER_FACTOR,
                    state_class=SensorStateClass.MEASUREMENT,
                    disabled_by_default=True,
                    value_fn=lambda d: _num(d.get("power_factor"))),
        WapdaSensor(coordinator, reference, "feeder_remarks",
                    category="load",
                    entity_category=EntityCategory.DIAGNOSTIC,
                    value_fn=lambda d: d.get("remarks") or "N/A"),
        WapdaSensor(coordinator, reference, "last_event",
                    category="load",
                    value_fn=_last_event_value,
                    attrs_fn=_last_event_attrs),
        WapdaSensor(coordinator, reference, "status_duration",
                    category="load",
                    value_fn=_status_duration_value),

        # --- User / Account sensors ---
        WapdaSensor(coordinator, reference, "account_name",
                    category="user",
                    entity_category=EntityCategory.DIAGNOSTIC,
                    value_fn=lambda d: (d.get("NAME") or "").strip()),
        WapdaSensor(coordinator, reference, "tariff",
                    category="user",
                    entity_category=EntityCategory.DIAGNOSTIC,
                    value_fn=lambda d: (d.get("TARIFF") or "").strip()),

        # --- Billing sensors ---
        WapdaSensor(coordinator, reference, "current_bill",
                    category="bill",
                    unit="PKR", state_class=SensorStateClass.TOTAL,
                    value_fn=lambda d: _bill_val(d, "currAmntDue")),
        WapdaSensor(coordinator, reference, "net_bill",
                    category="bill",
                    unit="PKR", state_class=SensorStateClass.TOTAL,
                    value_fn=lambda d: _bill_val(d, "netBill")),
        WapdaSensor(coordinator, reference, "bill_due_date",
                    category="bill",
                    value_fn=lambda d: _bill_str(d, "billDueDate")),
        WapdaSensor(coordinator, reference, "bill_due_in",
                    category="bill",
                    unit="days",
                    value_fn=_bill_due_in_value),
        WapdaSensor(coordinator, reference, "monthly_consumption",
                    category="bill",
                    device_class=SensorDeviceClass.ENERGY,
                    unit=UnitOfEnergy.KILO_WATT_HOUR,
                    state_class=SensorStateClass.TOTAL,
                    value_fn=lambda d: _bill_val(d, "totCurCons")),
        WapdaSensor(coordinator, reference, "arrears",
                    category="bill",
                    unit="PKR",
                    disabled_by_default=True,
        ...
        # Net metering
        WapdaSensor(coordinator, reference, "export_off_peak",
                    category="bill",
                    unit="units", state_class=SensorStateClass.TOTAL,
                    disabled_by_default=True,
                    value_fn=lambda d: _bill_val(d, "exp_op_units")),
        WapdaSensor(coordinator, reference, "export_peak",
                    category="bill",
                    unit="units", state_class=SensorStateClass.TOTAL,
                    disabled_by_default=True,
                    value_fn=lambda d: _bill_val(d, "exp_p_units")),
        WapdaSensor(coordinator, reference, "import_off_peak",
                    category="bill",
                    unit="units", state_class=SensorStateClass.TOTAL,
                    disabled_by_default=True,
                    value_fn=lambda d: _bill_val(d, "imp_op_units")),
        WapdaSensor(coordinator, reference, "import_peak",
                    category="bill",
                    unit="units", state_class=SensorStateClass.TOTAL,
                    disabled_by_default=True,
                    value_fn=lambda d: _bill_val(d, "imp_p_units")),
        WapdaSensor(coordinator, reference, "net_metering_balance",
                    category="bill",
                    unit="units",
                    value_fn=_net_metering_balance_value),

        # Charges breakdown
        WapdaSensor(coordinator, reference, "energy_charges",
                    category="bill",
                    unit="PKR",
                    disabled_by_default=True,
                    value_fn=lambda d: _charge_val(d, "companyCharges", "energyCharges")),
        WapdaSensor(coordinator, reference, "fixed_charges",
                    category="bill",
                    unit="PKR",
                    disabled_by_default=True,
                    value_fn=lambda d: _charge_val(d, "companyCharges", "fixedCharges")),
        WapdaSensor(coordinator, reference, "fpa",
                    category="bill",
                    unit="PKR",
                    disabled_by_default=True,
                    value_fn=lambda d: _bill_val(d, "totalFpa")),
        WapdaSensor(coordinator, reference, "gst",
                    category="bill",
                    unit="PKR",
                    disabled_by_default=True,
        ...
        # --- Schedule sensors ---
        WapdaSensor(coordinator, reference, "scheduled_outage_today",
                    category="schedule",
                    unit="hours",
                    value_fn=_scheduled_outage_today_value),
        WapdaSensor(coordinator, reference, "next_outage_in",
                    category="schedule",
                    unit="hours",
